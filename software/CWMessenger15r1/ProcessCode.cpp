...
void Send(char myChar)
{
  ...
  switch (myChar) {                 // Non-alpha and non-digit characters
    ...
    case '=':
      SendCode(0b00110001);         // Send dah di di di dah instead of Equal Sign

    //case '⌠':  // Multi-character constant char won't fly!
